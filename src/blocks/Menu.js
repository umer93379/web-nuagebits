                    ...
                    {data?.buttons && (
                      data?.buttons.map((butt) => {
                        ...
                        return <GatsbyLink className={
                          clsx({
                            'block py-2 pr-4 pl-3 text-headerTextDefaultColor hover:text-headerTextHoverColor rounded lg:bg-transparent lg:text-headerTextDefaultColor lg:hover:text-headerTextHoverColor dark:text-white': (button.variant === 'default'),

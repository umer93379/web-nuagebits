...
export default function Menu({ data }) {
  ...
  return (
    <header>
      {data?.social_links && (
        <nav class="bg-header-bg bg-headerBg text-headerTextDefaultColor border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 shadow">
      ...
      <nav class="bg-header-bg bg-headerBg text-headerTextDefaultColor border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 shadow">
          <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
              ...
              <div className={clsx({
                  ...
                  <div class="flex flex-col mt-4 font-medium lg:flex-row lg:align-right lg:space-x-8 lg:mt-0">
                    {data?.buttons && (

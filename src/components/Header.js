                ...
                {socialLinks?.social_links && (socialLinks?.social_links.map((link, i) => {
                  if(link.show_in_header === true){
                    switch (link.platform) {
                      case "email":
                        return (
                          <a className='space-x-2 flex h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG' href={`mailto:`+link.permalink} key={i}>
                      ...
                      case "phone":
                        return (
                          <a className='space-x-2 flex h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG' href={`tel:`+link.permalink} key={i}>
                      ...
                      case "calendar":
                        return (
                          <a className='space-x-2 flex h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG' href={link.permalink} key={i}>
                ...
                {socialLinks?.social_links && (socialLinks?.social_links.map((link, i) => {
                  if(link.show_in_header === true){
                    switch (link.platform) {
                      case "facebook":
                        return (
                          <a className='spce-y-2 lg:space-x-2 flex-0 h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG' href={link.permalink} key={i}>
                      ...
                      case "twitter":
                        return (
                          <a className='spce-y-2 lg:space-x-2 flex h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG' href={link.permalink} key={i}>
